...
describe('Given two authenticated users, user A and user B', () => {
  ...
  describe('When user A sends a tweet', () => {
    ...
    describe("When user B replies to user A's tweet", () => {
      ...
      it('Should save the reply in the Tweets table', async () => {
      ...
      it('Should increment the replies count in the Tweets table', async () => {
      ...
      it('Should save the reply in the Timelines table', async () => {
